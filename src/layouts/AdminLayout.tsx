        ...
        <div className="flex w-4/5">
            ...
            <div className="p-2 w-full">
                ...
                <div className="flex justify-between w-full">
                    <h2 className="font-sans font-semibold normal-case tracking-normal text-xl text-gray-800 leading-tight flex justify-between items-center mb-2">{title}</h2>
                    <div className="w-3/4 flex items-center justify-end flex-row mb-2">{action}</div>
                </div>
